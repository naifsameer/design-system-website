...
<div class="taps-box">
  <div class="taps">
    <h1 class="title">Taps Component</h1>
    <Line class="my-16" />
    ...
    <div>
      ...
      <div class="flex border-b border-gray-200 dark:border-gray-700">
        <button
          class="flex items-center h-10 px-2 py-2 -mb-px text-center text-blue-600 bg-transparent border-b-2 border-blue-500 sm:px-4 -px-1 dark:border-blue-400 dark:text-blue-300 whitespace-nowrap focus:outline-none"
        >
          <svg
    ...
    <div>
      <h2>End Closed With Icons</h2>

      <div class="flex">
        <button
          class="flex items-center h-12 px-2 py-2 text-center text-gray-700 border border-b-0 border-gray-300 sm:px-4 dark:border-gray-500 rounded-t-md -px-1 dark:text-white whitespace-nowrap focus:outline-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-4 h-4 mx-1 sm:w-6 sm:h-6"
...
<style lang="scss">
  .title {
    @apply my-6 mb-8 mt-16
        font-medium text-center text-3xl text-blue-900;
  }

  h2 {
    @apply my-6 mb-8 px-4 py-2
        font-medium text-center text-2xl text-red-500 border-2
        border-dotted border-red-600 max-w-max mx-auto;
  }

  .taps-box {
    @apply  px-2 py-4 pb-32;
  }
